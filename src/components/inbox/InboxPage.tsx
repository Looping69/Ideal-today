          ...
          <ScrollArea className="flex-1">
            {conversations.length === 0 ? (
              <div className="p-8 text-center text-gray-500">
                ...
                <p>No messages yet.</p>
                <p className="text-xs mt-1">Book a trip to start chatting with hosts.</p>
              </div>
            ) : (
              <div className="divide-y divide-gray-100">
                {conversations.map((conv) => (
                  ...
                  >
                    <Avatar>
                      <AvatarImage src={conv.property.host.avatar_url} />
                      <AvatarFallback><User className="w-4 h-4" /></AvatarFallback>
                    </Avatar>
                    <div className="flex-1 min-w-0">
                      <div className="flex justify-between items-start mb-1">
                        <h3 className="font-medium text-sm truncate pr-2">
                          {conv.property.host.full_name}
                        </h3>
                        {conv.last_message && (
        ...
        <div className={cn(
          ...
          {selectedConversation ? (
            <ChatWindow
              ...
              otherUserName={selectedConversation.property.host.full_name}
              otherUserAvatar={selectedConversation.property.host.avatar_url}
